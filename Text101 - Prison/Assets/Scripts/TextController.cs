...
public class TextController : MonoBehaviour {
	...
	private enum States {cell, mirror, sheets_0, lock_0, cell_mirror, sheets_1, 
		lock_1, corridor_0, stairs_0, stairs_1, stairs_2, courtyard, floor, 
	...
	void in_closet() { 
		text.text = "Inside the closet you see a cleaner's uniform that looks about " +
					"your size! " + "Seems like your day is looking-up.\n\n" + "Press " +
					"D to Dress up, or R to Return to the corridor"; 
	...
	void corridor_3() { 
		text.text = "You're standing back in the corridor, now convincingly dressed as " +
					"a cleaner. " + "You strongly consider the run for freedom.\n\n" + 
	...
	void floor () { text.text = "Rummagaing around on the dirty floor, you find a " +
					"hairclip.\n\n" + 
	...
	void stairs_2() { 
		text.text = "You feel smug for picking the closet door open, and are still " +
				"armed with " + "a hairclip (now badly bent). Even these achievements " +
				"together don't give " + "you the courage to climb up the staris to " +
				"your death!\n\n" + 
				"Press R to Return to the corridor";
		if (Input.GetKeyDown(KeyCode.R)) {myState = States.corridor_2;}
	}
	...
	void cell(){
		text.text = "You are in a prison cell, and you want to escape. There " +
					"are some dirty sheets on the bed, a mirror on the wall, and  " +
	...
	void cell_mirror() { 
		text.text = "You are still in your cell, and you STILL want to escape! There " + 
			"are some dirty sheets on the bed, a mark where the mirror was, " + 
	...
	void corridor_0() { 
		text.text = "You're out of your cell, but not out of trouble." + 
					"You are in the corridor, there's a closet and some stairs " +
					"leading to " + "the courtyard. There's also various detritus " +
					"on the floor.\n\n" + 
